  ...
  if (!isConnected) {
    return (
      <div className="min-h-[80vh] flex flex-col items-center justify-center space-y-6 container mx-auto px-4">
        ...
        <div className="bg-[#242424] border border-gray-800 p-12 rounded-2xl flex flex-col items-center justify-center max-w-lg w-full text-center">
    ...
    <div className="container mx-auto px-4 py-8 min-h-screen bg-[#000000]">
      ...
      <div className="flex justify-between items-center mb-10 mt-4">
        <div className="flex flex-col">
          <h1 className="text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-purple-600 mb-2 font-poppins">My Collection</h1>
          <p className="text-gray-400 text-lg">Manage your personal collection of Pokemon NFTs</p>
        </div>
        <div className="bg-purple-600/20 border border-purple-500/30 text-purple-400 px-5 py-2.5 rounded-xl font-bold text-lg shadow-[0_0_15px_rgba(147,51,234,0.15)] flex items-center gap-2">
      ...
      {isLoading ? (
        ...
        <div className="text-center py-24 bg-[#242424] border border-gray-800 rounded-2xl flex flex-col items-center justify-center">
